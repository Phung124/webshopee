        ...
        ?>
                ...
                <div class="grid_row app_content">
                    ...
                    <div class="grid_column10">
                        ...
                        <?php 
                $sql_home_product =mysqli_query($mysqli,"SELECT * FROM tbl_cartegory ORDER BY cartegory_id ASC");
                while($row_home_product = mysqli_fetch_array($sql_home_product)){
                    $id_cartegory = $row_home_product['cartegory_id']
